<template>
  <div class="puzzle-container" v-show="isVerificationShow">
    <div class="puzzle-header">
      ...
      <div>
        <span class="re-btn iconfont" @click="refreshImg">
          <svg-icon icon-class="'shuaxin'" />
        </span>
        <span class="close-btn iconfont" @click="closeVerificationBox">
...
.slider-btn {
  ...
  z-index: 12;
  cursor: pointer;
  background-image: url(../../../assets/images/puzieverificationp-sprite.3.2.0.png);
...
@font-face {
  ...
  src: url("../../../assets/iconfont/iconfont.eot?t=1565160368550"); /* IE9 */
  src: url("../../../assets/iconfont/iconfont.eot?t=1565160368550#iefix")
    ...
    /* IE6-IE8 */
      ...
      format("woff2"),
    url("../../../assets/iconfont/iconfont.woff?t=1565160368550") format("woff"),
    url("../../../assets/iconfont/iconfont.ttf?t=1565160368550")
      format("truetype"),
    /* chrome, firefox, opera, Safari, Android, iOS 4.2+ */
      url("../../../assets/iconfont/iconfont.svg?t=1565160368550#iconfont")
      format("svg"); /* iOS 4.1- */
}
